    ...
    <ScrollView style={[styles.container, { backgroundColor: theme.background }]}>
      <View style={styles.header}>
        ...
        <View style={styles.headerContent}>
          ...
          <Text style={[styles.username, { color: theme.color, fontWeight: 'bold' }]}>Maxwell Kpetsey</Text>
        </View>
      ...
      <View style={styles.actionRow}>
        ...
        <TouchableOpacity style={styles.actionButton}>
          <BlurView intensity={0} style={styles.actionImageContainer}>
            <Image style={styles.actionImage} source={require('../assets/recieve.png')} />
          </BlurView>
          <Text style={[styles.actionText, { color: theme.color }]}>Recieve</Text>
        </TouchableOpacity>
        <TouchableOpacity style={styles.actionButton}>
          <BlurView intensity={0} style={styles.actionImageContainer}>
      ...
      <View style={styles.transactionSection}>
        ...
        <BlurView intensity={0} style={styles.actionImageContainer}>
          <View style={[styles.transactionIconContainer, { backgroundColor: theme.iconBackground }]}>
            <Image style={styles.transactionIcon} source={require('../assets/apple.png')} />
            </View>
          </BlurView>
